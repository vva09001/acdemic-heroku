    ...
    <React.Fragment>
      <div className="form addForm">
        <Label
          ...
          name="classId"
          type="text"
          value={props.validatedClassForm.classId}
          onChange={e => props.validateClassId(e.target.value)}
          onBlur={e => props.validateClassId(e.target.value)}
        />
        <ErrorMsg error={props.classId_err} />
        <Label
          classes="formItem"
          labelName="Tên lớp*:"
          name="className"
